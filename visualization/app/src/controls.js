...
/**
 * Fully client-computable parameter (β, ω, α, speed): slider and number
 * box share the same bounded range, both live (fire on every input, no
 * commit step needed since there's no backend/resolution ladder involved).
